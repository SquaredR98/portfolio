...
const SkillCard = ({ title, skills }) => {
  return (
    ...
    >
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-slate-50 via-slate-50/95 to-slate-50/80 dark:from-slate-900 dark:via-slate-900/95 dark:to-slate-900/90 -z-[1]" />
