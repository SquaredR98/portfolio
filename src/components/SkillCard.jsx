...
const SkillCard = ({ title, skills }) => {
	...
	return (
		<div
			className='border p-4 z-[-2] dark:z-0 my-6 dark:border-none dark:bg-slate-900 shadow-lg relative'
			style={{
		...
		>
			<div className='absolute top-0 left-0 w-full h-full bg-gradient-to-r from-slate-900 via-slate-900/95 to-slate-900/80 -z-[1]' />
