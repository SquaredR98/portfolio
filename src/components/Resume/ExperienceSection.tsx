...
const experiences = [
	{
		...
		description: 'Leading end-to-end implementation of Offers Dashboard, building Rewards UI in Next.js for NeoZAP\'s mobile app, and implementing Spin the Wheel feature using react-custom-roulette.',
		achievements: [
		...
		technologies: ['ReactJS', 'PrimeReact', 'react-hook-form', 'Next.js', 'SSR', 'Node.js']
	},
	{
		id: 2,
		...
		location: 'Gurugram, Haryana',
		description: 'Led development of NeoZAP\'s marketing website, integrated multiple payment gateways, and architected content management dashboard. Collaborated with marketing team for analytics integration.',
		achievements: [
		...
		technologies: ['Next.js', 'Tailwind CSS', 'Framer Motion', 'RTK', 'Razorpay', 'Paytm', 'Cashfree', 'Google Analytics']
	},
	{
		id: 3,
		...
		location: 'Gurugram, Haryana',
		description: 'Developed RBAC and authentication modules, built feature testing simulator, and led backend architecture for various platforms. Mentored new team members.',
		achievements: [
		...
		technologies: ['NestJS', 'PostgreSQL', 'Node.js', 'MongoDB', 'Serverless Framework', 'AWS Lambda']
	},
	{
		id: 4,
		title: 'Software Developer',
		...
		description: 'Developed comprehensive product management and inventory management system, engineered invoicing tools, and managed entire software lifecycle as sole engineer.',
		achievements: [
		...
		technologies: ['Node.js', 'MongoDB', 'Express', 'EJS', 'PHP', 'MySQL', 'JavaScript']
	}
];
	...
	return (
		...
		>
			<MotionH3 className="text-2xl font-bold text-white flex items-center gap-3">
				<HiBriefcase className="w-6 h-6 text-fuchsia-500" />
				...
				{experiences.map((exp, index) => (
					...
					>
						<div className="flex flex-col md:flex-row md:items-start justify-between mb-4">
							<div>
								<MotionH4 className="text-xl font-bold text-white mb-1">{exp.title}</MotionH4>
								<MotionP className="text-fuchsia-400 font-medium">{exp.company}</MotionP>
							</div>
						...
						<MotionP className="text-slate-300 mb-4">{exp.description}</MotionP>
						<div className="mb-4">
							<MotionH5 className="text-white font-semibold mb-2">Key Achievements:</MotionH5>
