					...
					>
						<div>
							...
							<p className="text-slate-400 text-lg leading-relaxed">
								...
								possibilities, I&apos;d love to connect with you.
							</p>
						</div>
							...
							{contactInfo.map((contact, index) => (
								...
								>
									<div className="flex items-start gap-4">
										<div className={`p-3 rounded-lg bg-slate-700 group-hover:bg-slate-600 transition-colors ${contact.color}`}>
						...
						<div className="bg-slate-900 rounded-xl p-6 border border-slate-800">
							<h4 className="text-white font-semibold mb-3">What I Offer</h4>
							...
							<div className="space-y-6">
								<div className="bg-slate-800 rounded-xl p-6 border border-slate-700">
									...
									<p className="text-slate-400 text-sm mb-4">
										Have a project in mind? Send me a detailed message and I&apos;ll get back to you within 24 hours.
									</p>
									<button
								...
								<div className="bg-slate-800 rounded-xl p-6 border border-slate-700">
									...
									<p className="text-slate-400 text-sm mb-4">
										Prefer to talk? Schedule a Google Meet to discuss your project in detail.
									</p>
									<button
										onClick={() => setContactFormVisible(true)}
