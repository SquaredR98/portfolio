    ...
    <div className="w-11/12 md:w-10/12 lg:w-8/12 mx-auto grid grid-rows-2 md:grid-cols-2 h-screen">
      <div className="flex flex-col items-center justify-start md:items-start md:justify-center h-screen">
        ...
        <MotionButton
          ...
          className="uppercase w-full md:w-2/3 lg:w-1/2 my-2 py-2 px-8 text-slate-900 bg-none md:mr-8 border border-slate-950 dark:border-cyan-300 dark:bg-none dark:text-cyan-300 hover:shadow-md hover:dark:shadow-cyan-300/20 hover:tracking-widest transition-all duration-300"
        >
          Get in Touch
        </MotionButton>
      </div>
