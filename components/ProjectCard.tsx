						...
						<div className='col-span-2 order-last lg:order-first'>
							<ul className='list-disc list-outside pl-6'>
								{about.map((el, idx) => (
									<li
										key={idx}
										className='dark:font-extralight my-1 tracking-wide text-gray-500 dark:text-slate-400 group-hover:text-slate-900 group-hover:dark:text-white'
									>
										{el}
									</li>
								))}
				...
				<MotionCardFooter className='gap-2 my-2 flex-wrap'>
					{github ? (
						<a
							href={github}
							target='_blank'
							className='hover:dark:text-cyan-300'
						>
							Github Link
						</a>
					) : (
