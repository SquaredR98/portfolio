		...
		<section id='contact' className='dark:bg-slate-950'>
			<div className='w-11/12 lg:w-9/12 mx-auto'>
				...
				<div className='grid  grid-cols-1 lg:grid-cols-2 md:py-16'>
					<div className='mb-8'>
						<p className='dark:font-extralight my-2'>
							Reach out to me if you
						</p>
						<ul className='dark:font-extralight list-disc pl-6'>
							<li>Have an idea for a website?</li>
							<li>
								Want to translate figma to
								react?
							</li>
							<li>
								Want to consult technologies for
								your next project?
							</li>
							<li>
								Need support for the maintenance
								of current project?
							</li>
						</ul>
						<p className='dark:font-extralight my-2 mb-4'>
							I would be happy to help you in
              ...
              +91 829 551 9455
					...
					<div className='mb-8 lg:mb-0'>
						<p className='text-sm dark:text-slate-600 dark:text-extralight'>
							Form is under development. Will be
							active in few days. Use the details
							provided to contact.
						</p>
						<form
