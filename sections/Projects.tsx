			...
			<div className='w-11/12 lg:w-9/12 mx-auto my-16'>
				...
				<div className='flex flex-col-reverse lg:flex-row mt-8'>
					<div className='w-full lg:w-1/2'>
						...
						>
							<li>
								A landing page for the food
								rating app call Foodaholix.
							</li>
							<li>
								Website includes blog but with
								static content without any blog
								CMS using only JSON.
							</li>
							<li>
								I worked on translating the
								legacy HTML & CSS code to the
								updated React and Gatsby.
							</li>
							<li>
								Initially the styling was done
								with Styled Components but later
								on translated to tailwindCSS by
								me for better UI.
							</li>
							<li>
				...
				<div className='flex flex-col-reverse lg:flex-row mt-8'>
					<div className='lg:w-1/2'>
						...
						>
							<li>
								Find all movies and TV Shows.
								Search and see rating and
								details of each one.
							</li>
							<li>
								Developed using React & NextJS
								with server components for SSR.
							</li>
							<li>
								Styled with the help of
								TailwindCSS
							</li>
							<li>
								My personal project to showcase
								the NextJS and API integration
								skills
							</li>
							<li>
								The project has been developed
