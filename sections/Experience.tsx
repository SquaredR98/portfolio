		...
		<section id='experience' className='dark:bg-slate-950'>
			<div className='w-11/12 lg:w-9/12 mx-auto dark:bg-slate-950 my-16'>
				...
				<MotionH4 className='text-xl tracking-wide font-[500] relative z-[1]'>
					Antino Labs -{' '}
					<span className='text-base font-[200]'>
						April 2022 - Present
					</span>
				</MotionH4>
				...
				>
					<li className='my-1'>
						...
						including INeuron, Devlabs Alliance, Casha,
						Travel Hangouts, Top Faculty, and more
					</li>
					<li className='my-1'>
						Work alongside creative people to lead
					...
					<li className='my-1'>
						...
						concepts into production realities for
						clients and stakeholders.
					</li>
					<li className='my-1'>
						Lead multiple projects and provide training
						and mentorship to the new joinees in order
						to help them grow and learn quickly.
					</li>
				</ul>
				...
				<div className='border dark:border-white/30 px-4 py-4 rounded-lg mt-2'>
					<MotionH4
						className={`text-xl ${poppins.className} font-bold`}
					>
						Neo Finity
					</MotionH4>
					<div>
						<p className={`${poppins.className} mt-2`}>
							What is the product?
						</p>
						<ul
						...
						>
							<li>
								The product is a fintech
								application where users can load
								balance and make payments
								through cards and wearables
								making it advance payment
								solutions.
							</li>
						</ul>
					</div>
					<div>
						...
						>
							<li>
								...
								waitlist allowing users to sign
								up and sign in via OTP in react
								along with other necessary CRUD
								operation integrated into it.
							</li>
							<li>
								Translated the waitlist from
								react to nextjs due to SEO &
								product requirements.
							</li>
							<li>
								Translated the figma design for
								a neofinity landing page in
								nextjs along with smooth
								animations
							</li>
						</ul>
					</div>
				...
				<div className='border dark:border-white/30 px-4 py-4 rounded-lg mt-6'>
					...
					<div>
						...
						>
							<li>
								Worked on the P2P video call
								feature implementation using
								WebRTC in React & Node.
							</li>
						</ul>
					</div>
					<div>
				...
				<div
					className={`flex justify-end my-4 ${poppins.className}`}
				>
					<Link
